...
The count is the argument. Of the 46 documented failures, **41 were fixed
...
personal-ai/
  pai/
    ...
    extract.py       first-person fact extraction; retraction patterns
  ...
  eval/evidence/
    mutation_audit_88.txt       raw output of the 88-mutation pass

docs/                          <- repository root, not personal-ai/docs/
  conversational-llm-architecture.md   the R&D evaluation (brief 1)
  personal-ai-architecture.md          the personal-AI design (brief 2)
```
