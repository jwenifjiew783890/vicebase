...
| `docs/CONVERSATION-FAILURES.md` | all 45 failures, plus the one gap that was built rather than fixed, each quoted from the transcript that produced it |
...
Of 45 documented failures, 40 were fixed in deterministic code outside the
