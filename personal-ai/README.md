...
| `docs/CONVERSATION-FAILURES.md` | all 43 failures, plus the one gap that was built rather than fixed, each quoted from the transcript that produced it |
...
Of 43 documented failures, 38 were fixed in deterministic code outside the
