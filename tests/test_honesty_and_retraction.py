...
from vision.core.gateway import Action, Channel, ExecStatus, Trust
from vision.core.memory import MemoryStore
from vision.core.obsidian import VaultIndex, TfidfEmbedder
from vision.core.orchestrator import (NO_ACTION_REPLY, NO_EVIDENCE_REPLY,
                              RETRACTION_REPLY, SOURCE_CLAIM, Orchestrator)
from vision.core.router import Path, Router
from vision.core.web import WebResult
...
class TestFenceProvenance(unittest.TestCase):
    ...
    def test_the_vault_is_described_as_his_own(self):
        from vision.core.gateway import wrap_untrusted
...
class TestPersonaIdentity(unittest.TestCase):
    ...
    def test_the_persona_states_the_negative_explicitly(self):
        from vision.core.orchestrator import BASE_PERSONA
...
class TestCorrectionIsNotCancellation(unittest.TestCase):
    ...
    def test_a_correction_carrying_content_is_not_bare(self):
        from vision.core.orchestrator import _is_bare_retraction
    ...
    def test_cancelling_still_happens_for_a_correction(self):
        ...
        from vision.core.router import Router
