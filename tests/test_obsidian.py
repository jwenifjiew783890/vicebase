...
from vision.core.obsidian import (VaultIndex, TfidfEmbedder, chunk_note,
                          parse_frontmatter, _note_name)
from vision.core.gateway import Tainted, is_tainted
...
class TestSafety(unittest.TestCase):
    ...
    def test_fts_query_is_built_not_passed_through(self):
        ...
        """
        from vision.core.obsidian import _fts_query
